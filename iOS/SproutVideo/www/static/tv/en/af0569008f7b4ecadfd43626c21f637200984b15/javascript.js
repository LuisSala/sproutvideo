...
sc_require("models/video_record");Tv.VideoRecord.FIXTURES=[{guid:1,title:"Cat Plays Piano",url:"http://pseudo01.hddn.com/vod/demo.flowplayervod/flowplayer-960.mp4",previewUrl:"http://flowplayer.org/img/demos/70930.jpg",description:"Non maximo publicate essentialmente es, non vices tamben national un, via e instruite traduction. Sitos regula quotidian que al. Non ample vostre qualcunque ma, debe regula sed es, web celo libro pardona in. Que iala publication su. In iste anque nos, scriber anteriormente pro al. De con resultato interlingua, le latino nostre abstracte pan, al pan como movimento.",bookmarked:NO},{guid:2,title:"Cat Plays Piano",url:"http://blip.tv/file/get/Achievementhunter-HaloReachFailsOfTheWeakVolume31FunnyHaloBloopersAnd603.m4v",previewUrl:"http://flowplayer.org/img/demos/70930.jpg",description:"Via signo ascoltar il, libera contos pro ha. Non europee appellate su, se uso studio scientia, su duo americano excellente immediatemente. Sia tres cadeva debitores es, un que esser populos simplificate. Su duo medio nomina capital, texto europa methodicamente es qui.",bookmarked:NO},{guid:3,title:"Cat Plays Piano",url:"http://pseudo01.hddn.com/vod/demo.flowplayervod/flowplayer-960.mp4",previewUrl:"http://flowplayer.org/img/demos/70930.jpg",description:"O etiam publication web, se uso usos signo publication. Via tu laborava avantiate, ma nos toto americano. Non libere historia ma. Veni servi maximo qui e, via e peano campo laborava. Sitos regula pro un.",bookmarked:NO},{guid:4,title:"Cat Plays Piano",url:"http://pseudo01.hddn.com/vod/demo.flowplayervod/flowplayer-960.mp4",previewUrl:"http://flowplayer.org/img/demos/70930.jpg",description:"Il duo ille ample scriber. Al que celo philologos technologia, via medio europee historia ha. Usos original dictionario es non, europee durante anteriormente qui il. Con es lingua capital, que su nostre instituto. Se quales moderne avantiate del, da uso medio spatios. Tote resultato sanctificate da nos, su sanctificate anteriormente web.",bookmarked:NO},{guid:5,title:"Cat Plays Piano",url:"http://pseudo01.hddn.com/vod/demo.flowplayervod/flowplayer-960.mp4",previewUrl:"http://flowplayer.org/img/demos/70930.jpg",description:"De qui denominator independente. Un prime subjecto sia, o lateres paternoster continentes duo, basate finalmente sed in. Gode nostre introduction uso tu, nomina mundial interlinguistica sed le. E malo celos del, mundial quotidian occidental web tu, tote membros uso tu.",bookmarked:NO},];
...
context.attr("style","background-image:url("+this.get("previewUrl")+")");context.begin("img").attr("src","http://flowplayer.org/img/player/btn/play_large.png").end()
